...
#'
#' Description:
#'   Advanced network visualization (v2.1) for transcriptome-metabolome integration.
#   Creates publication-quality network plots with three color scales (pathways,
#   genes, metabolites), fixed layout across comparisons for visual consistency,
#   and Cytoscape-compatible export.
#'
#' Input:
#'   gene_metabolite_pathway_group.csv,
#   gene_metabolite_pathway_group_MetaboliteFC_v2.csv
#'
#' Output:
#'   Individual network PNGs/PDFs per comparison (HFD vs SD, DR vs HFD,
#   EX vs HFD, DREX vs HFD), combined_networks.pdf/png, cytoscape_network.graphml,
#   fixed_layout.rds
#'
#' Related figures:
#'   Fig. 5A-D
