#' ============================================================================
#' Multivariate Omics Analysis Helper Functions
#' ============================================================================
#'
...
#'
#' Description:
#'   Comprehensive function library (~3,200 lines) for multivariate omics analysis.
#   Provides PCA (FactoMineR), PLS-DA with VIP scoring (mixOmics), cross-validation,
#   OSC-PLS, S-plots, and various visualization functions. Sourced by other
#   metabolomics scripts.
#'
#' Input:
#'   (Sourced by other scripts; not run standalone)
#'
#' Output:
#'   (Provides functions to other scripts)
#'
#' Related figures:
#'   Supporting functions for Fig. 4, Fig. S9-S10
#'
#' ============================================================================
#################################################################################
